package com.ericsson.ci.cloud.eniq_cdb_setup.test.steps;

import org.testng.annotations.Test;

import com.ericsson.ci.cloud.eniq_cdb_setup.operators.EnvironmentSetUpOperatorCli;
...
*/
    ...
    /*@TestStep(id = "Dcc_Dppi_Setup")
    public void verifyDccDppiSetup() {
        assertTrue(operator.executeInitialInstall());
    }
